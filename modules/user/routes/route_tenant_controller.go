...
func routeTenantController(engine fiber.Router, controller *controller.TenantController) {
	...
	engine.Get(strings.TrimPrefix("/v1/users/tenants/:id<int>", basePath), DataFunc1(controller.Show, Integer[int64]("id", PathParamError)))
	...
	engine.Put(strings.TrimPrefix("/v1/users/tenants/:id<int>", basePath), Func2(controller.Update, Integer[int64]("id", PathParamError), Body[dto.TenantForm](BodyParamError)))
	engine.Delete(strings.TrimPrefix("/v1/users/tenants/:id<int>", basePath), Func1(controller.Delete, Integer[int64]("id", PathParamError)))
}
