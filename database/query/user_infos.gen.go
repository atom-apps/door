...
func newUserInfo(db *gorm.DB, opts ...gen.DOOption) userInfo {
	...
	_userInfo.Biography = field.NewString(tableName, "biography")
	_userInfo.Tag = field.NewString(tableName, "tag")
	_userInfo.Language = field.NewString(tableName, "language")
	_userInfo.Gender = field.NewField(tableName, "gender")
	_userInfo.Birthday = field.NewTime(tableName, "birthday")
	_userInfo.Education = field.NewString(tableName, "education")
...
func (u *userInfo) fillFieldMap() {
	...
	u.fieldMap["affiliation"] = u.Affiliation
	u.fieldMap["title"] = u.Title
	u.fieldMap["id_card_type"] = u.IDCardType
