...
type FilesystemForm struct {
	...
	Metadata  model.FilesystemMetadata `form:"metadata" json:"metadata,omitempty"`     // 元数据
}
...
type FilesystemListQueryFilter struct {
	...
	Metadata  *model.FilesystemMetadata `query:"metadata" json:"metadata,omitempty"`     // 元数据
}
...
type FilesystemItem struct {
	...
	Metadata  model.FilesystemMetadata `json:"metadata,omitempty"`   // 元数据
