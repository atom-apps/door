...
type ITokenDo interface {
	...
	Unscoped() ITokenDo
	Create(values ...*models.Token) error
	CreateInBatches(values []*models.Token, batchSize int) error
	Save(values ...*models.Token) error
	First() (*models.Token, error)
	Take() (*models.Token, error)
	Last() (*models.Token, error)
	Find() ([]*models.Token, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Token, err error)
	FindInBatches(result *[]*models.Token, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Token) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Token, error)
	FirstOrCreate() (*models.Token, error)
	FindByPage(offset int, limit int) (result []*models.Token, count int64, err error)
