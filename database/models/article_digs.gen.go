...
type ArticleDig struct {
	...
	Views     uint64    `gorm:"column:views;type:bigint(20) unsigned;comment:浏览量" json:"views"`                        // 浏览量
	Likes     uint64    `gorm:"column:likes;type:bigint(20) unsigned;comment:喜欢" json:"likes"`                         // 喜欢
	Dislikes  uint64    `gorm:"column:dislikes;type:bigint(20) unsigned;comment:不喜欢" json:"dislikes"`                  // 不喜欢
}
