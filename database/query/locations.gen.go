...
func newLocation(db *gorm.DB, opts ...gen.DOOption) location {
	...
	_location.Area = field.NewString(tableName, "area")
	_location.Town = field.NewString(tableName, "town")
...
func (l *location) updateTableName(table string) *location {
	...
	l.Area = field.NewString(table, "area")
	l.Town = field.NewString(table, "town")
...
func (l *location) fillFieldMap() {
	...
	l.fieldMap["area"] = l.Area
	l.fieldMap["town"] = l.Town
}
