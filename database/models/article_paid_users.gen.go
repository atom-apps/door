...
type ArticlePaidUser struct {
	...
	PriceType int64     `gorm:"column:price_type;type:bigint(20);comment:付费类型" json:"price_type"`                      // 付费类型
	Price     uint64    `gorm:"column:price;type:bigint(20) unsigned;comment:付费价格" json:"price"`                       // 付费价格
	EndAt     uint64    `gorm:"column:end_at;type:bigint(20) unsigned;comment:付费结束时间" json:"end_at"`                   // 付费结束时间
}
