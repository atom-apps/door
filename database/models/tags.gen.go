...
type Tag struct {
	...
	Count     uint64         `gorm:"column:count;type:bigint(20) unsigned;comment:引用次数" json:"count"`                        // 引用次数
	Views     uint64         `gorm:"column:views;type:bigint(20) unsigned;comment:点击次数" json:"views"`                        // 点击次数
}
