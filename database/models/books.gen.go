...
type Book struct {
	...
	ThumbnailFileID uint64         `gorm:"column:thumbnail_file_id;type:bigint(20) unsigned;comment:封面" json:"thumbnail_file_id"`  // 封面
	...
	Price           uint64         `gorm:"column:price;type:bigint(20) unsigned;comment:价格" json:"price"`                          // 价格
}
