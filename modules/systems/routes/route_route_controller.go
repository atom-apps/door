...
func routeRouteController(engine fiber.Router, controller *controller.RouteController) {
	...
	engine.Get(strings.TrimPrefix("/v1/systems/routes/type/:routeType", basePath), DataFunc2(controller.Pages, JwtClaim[jwt.Claims](ClaimParamError), String("routeType", PathParamError)))
