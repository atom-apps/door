<template>
    <form class="flex flex-col w-full my-5">
        ...
        <div class="form-control w-full">
            ...
            <input type="text" name="username" v-model="form.username" @keypress.enter="usernamePressEnter"
        ...
        <button @click.prevent="submit" class="my-5 btn btn-lg lg:btn-xl btn-primary my-10"
            :disabled="loading">
